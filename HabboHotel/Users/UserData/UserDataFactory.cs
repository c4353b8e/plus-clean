    ...
    public static class UserDataFactory
    {
        public static UserData GetUserData(string SessionTicket, out byte errorCode)
        {
            ...
            using (var dbClient = Program.DatabaseManager.GetQueryReactor())
            {
                ...
                if (Program.GameContext.GetClientManager().GetClientByUserId(userId) != null)
                {
                    errorCode = 2;
                    Program.GameContext.GetClientManager().GetClientByUserId(userId).Disconnect();
                    return null;
                }
        ...
        public static UserData GetUserData(int UserId)
        {
            ...
            using (var dbClient = Program.DatabaseManager.GetQueryReactor())
            {
                ...
                Program.GameContext.GetClientManager().LogClonesOut(Convert.ToInt32(UserId));
