namespace Plus.Game.Users.Inventory
{
    using System;
    ...
    public class InventoryComponent
    {
        ...
        public InventoryComponent(int userId, Player client)
        {
            _client = client;
            _userId = userId;
        ...
        public void TryAddPet(Pet pet)
        {
            //TODO: Sort this mess. - Give me an explanation of what you want sorted, to me this seems fine? - Dom
            pet.RoomId = 0;
            pet.PlacedInRoom = false;

            _petsItems.TryAdd(pet.PetId, pet);
        }
