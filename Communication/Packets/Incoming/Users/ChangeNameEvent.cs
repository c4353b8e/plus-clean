namespace Plus.Communication.Packets.Incoming.Users
{
    ...
    internal class ChangeNameEvent : IPacketEvent
    {
        public void Parse(Player session, ClientPacket packet)
        {
            ...
            foreach (var ownRooms in Program.GameContext.GetRoomManager().GetRooms().ToList())
            {
            ...
            Program.GameContext.GetAchievementManager().ProgressAchievement(session, "ACH_Name", 1);
