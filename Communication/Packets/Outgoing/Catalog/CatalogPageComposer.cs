namespace Plus.Communication.Packets.Outgoing.Catalog
{
    ...
    public class CatalogPageComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.CatalogPageMessageComposer)
        {
            ...
            if (!Page.Template.Equals("frontpage") && !Page.Template.Equals("club_buy"))
            {
                ...
                foreach (var Item in Page.Items.Values)
                {
                    ...
                    if (Item.Data.InteractionType == InteractionType.DEAL || Item.Data.InteractionType == InteractionType.ROOMDEAL)
                    {
                        ...
                        if (!Program.GameContext.GetCatalog().TryGetDeal(Item.Data.BehaviourData, out deal))
                        {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else if (Item.Data.InteractionType == InteractionType.BOT)//Bots
                            {
                                ...
                                if (!Program.GameContext.GetCatalog().TryGetBot(Item.ItemId, out CatalogBot))
                                {
            ...
            WriteInteger(Program.GameContext.GetCatalog().GetPromotions().ToList().Count);//Count
            foreach (var Promotion in Program.GameContext.GetCatalog().GetPromotions().ToList())
            {
