namespace Plus.Core.FigureData
{
    ...
    {
        private static readonly ILogger Logger = new Logger<FigureDataManager>();
        ...
        public string ProcessFigure(string figure, string gender, ICollection<ClothingParts> clothingParts, bool hasHabboClub)
        {
            ...
            {
                var purchasableParts = Program.GameContext.GetCatalog().GetClothingManager().GetClothingAllParts;
